...
class Testimonial3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Testimonial 3', 'designbox-builder' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Section Title', 'designbox-builder' ),
				...
				'default'     => esc_html__( 'MY CLIENTS SAY ME BEST ONE', 'designbox-builder' ),
			]
		);
		...
		$this->add_control(
			'testimonials',
			[
				'label'   => esc_html__( 'Testimonials', 'designbox-builder' ),
		...
		$this->add_control(
			'quote_icon',
			[
				'label'            => esc_html__( 'Quote', 'designbox-builder' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Section Border', 'designbox-builder' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb__testimonial-3.style-1 .quote'                                                                                => 'border-inline-end-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial-3.style-1 .quote:before, {{WRAPPER}} .wdb__testimonial-3.style-1 .quote:after'                   => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial-3.style-1'                                                                                       => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial-3.style-1 .wdb-arrow-next'                                                                       => 'border-top-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial-3.style-1 .wdb-arrow-next:before'                                                                => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial-3.style-1 .main-title'                                                                           => 'border-inline-end-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial-3.style-1 .main-title:before, {{WRAPPER}} .wdb__testimonial-3.style-1 .main-title:after'         => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial-3.style-1 .wdb__slider'                                                                          => 'border-inline-end-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial-3.style-1 .ts-navigation::after, {{WRAPPER}} .wdb__testimonial-3.style-1 .ts-navigation::before' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			'quote_color',
			[
				'label'     => esc_html__( 'Quote Color', 'designbox-builder' ),
				'type'      => Controls_Manager::COLOR,
				'separator' => 'before',
				'selectors' => [
		...
		$this->add_responsive_control(
			'quote_size',
			[
				'label'      => esc_html__( 'Quote Size', 'designbox-builder' ),
	...
	private function slider_navigation_style_controls() {
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Arrows', 'designbox-builder' ),
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper',
			[
				'class'         => [ 'wdb__t_slider-wrapper wdb__testimonial-3', 'style-1' ],
