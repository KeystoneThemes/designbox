...
class Social_Icons extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Social Icons', 'designbox-builder' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}}.wdb-social-icon' => 'color: {{VALUE}};fill: {{VALUE}};',
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}}.wdb-social-icon'   => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'separator' => 'before',
				'selectors' => [
					'{{WRAPPER}} .wdb--social-icons ul' => 'justify-content: {{VALUE}}; align-items: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'   => 'row',
				'options'   => [
					'row'    => esc_html__( 'row', 'designbox-builder' ),
					'column' => esc_html__( 'column', 'designbox-builder' ),
				],
				'selectors' => [
					'{{WRAPPER}} .wdb--social-icons ul' => 'display: flex; flex-direction: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-social-icon' => 'color: {{VALUE}};fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-social-icon' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb-social-icon' => '--icon-size: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb-social-icon' => '--icon-padding: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb--social-icons ul' => 'gap: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'icon_border',
				'selector' => '{{WRAPPER}} .wdb--social-icons ul li a',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb-social-icon' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon Hover', 'designbox-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .wdb-social-icon:hover, {{WRAPPER}} .wdb-social-icon:focus' => 'color: {{VALUE}}; fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-social-icon:hover, {{WRAPPER}} .wdb-social-icon:focus'   => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-social-icon:hover, {{WRAPPER}} .wdb-social-icon:focus' => 'border-color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'socials-attr', 'class', 'wdb--social-icons' );
		?>
		<div <?php $this->print_render_attribute_string( 'socials-attr' ); ?>>
			<ul>
				<?php
				foreach ( $settings['wdb_social_icons'] as $index => $item ) {
