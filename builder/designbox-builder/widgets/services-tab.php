...
class Services_Tab extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Services Tab', 'designbox-builder' );
	}
	...
	public function get_style_depends() {
		return [ 'wdb--services-tab', 'wdb--button'];
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( '01', 'designbox-builder' ),
				'placeholder' => esc_html__( '01', 'designbox-builder' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[ 'tab_number' => esc_html__( '01', 'designbox-builder' ) ],
					[ 'tab_number' => esc_html__( '02', 'designbox-builder' ) ],
					[ 'tab_number' => esc_html__( '03', 'designbox-builder' ) ],
				],
		...
		$this->add_responsive_control(
			'navigation_width',
			[
				'label'     => esc_html__( 'Tabs Width', 'designbox-builder' ),
				...
				'selectors' => [
					'{{WRAPPER}} .wdb--services-tab' => '--image-width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Tab Title', 'designbox-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'tab_number_heading',
			[
				'label'     => esc_html__( 'Tab Number', 'designbox-builder' ),
		...
		$this->add_responsive_control(
			'button_margin',
			[
				'label'      => esc_html__( 'Button Margin', 'designbox-builder' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'separator'  => 'after',
				'range'      => [
