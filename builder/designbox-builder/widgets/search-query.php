...
class Search_Query extends Widget_Base {
	...
	public function get_name() {
		return 'wdb--blog--search--query';
	}

	public function get_title() {
		return esc_html__( ' Search Query', 'designbox-builder' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'search_text',
			[
				'label'   => esc_html__( 'Search Text', 'designbox-builder' ),
		...
		$this->start_controls_section(
			'section_query_style',
			[
				'label' => __( 'Query Text Style', 'designbox-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
