...
class Post_Excerpt extends Widget_Base {
	...
	public function get_name() {
		return 'wdb--blog--post--excerpt';
	}

	public function get_title() {
		return esc_html__( ' Post Excerpt', 'designbox-builder' );
	}

	public function get_icon() {
		return 'wdb eicon-post-excerpt';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'limit',
			[
				'label'   => esc_html__( 'Limit', 'designbox-builder' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'separator' => 'before',
				'selectors' => [
					'{{WRAPPER}} .wdb-post-excerpt' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-post-excerpt' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'typography',
				'selector' => '{{WRAPPER}} .wdb-post-excerpt',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb-post-excerpt' => 'mix-blend-mode: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
	...
	protected function render() {
		...
		echo '<div class="wdb-post-excerpt">' . $content . '</div>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
