...
class Testimonial2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Testimonial 2', 'designbox-builder' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb__testimonial-2.style-2 .picture::before' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			'image_width',
			[
				'label'      => esc_html__( 'Image Size', 'designbox-builder' ),
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper',
			[
				'class'         => [ 'wdb__t_slider-wrapper wdb__testimonial-2', 'style-' . $settings['element_list'] ],
