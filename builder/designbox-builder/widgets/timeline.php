...
class Timeline extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Timeline', 'designbox-builder' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'date_icon',
			[
				'label'            => esc_html__( 'Date Icon', 'designbox-builder' ),
		...
		$this->add_responsive_control(
			'image_position',
			[
				'label'          => esc_html__( 'Image position', 'designbox-builder' ),
				'type'           => Controls_Manager::SELECT,
				'default'        => 'column',
				'tablet_default' => 'column',
				'mobile_default' => 'column',
				'options'        => [
					'column' => esc_html__( 'Top', 'designbox-builder' ),
					'row'    => esc_html__( 'Aside', 'designbox-builder' ),
				],
				'prefix_class'   => 'wdb-image-position-',
				'selectors'      => [
		...
		$this->add_control(
			'show_indicator',
			[
				'label'        => esc_html__( 'Indicator', 'designbox-builder' ),
		...
		$repeater->add_control(
			'step_type',
			[
				'label'   => esc_html__( 'Step Type', 'designbox-builder' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'icon',
				'options' => [
		...
		$repeater->add_control(
			'step_icon',
			[
				'label'            => esc_html__( 'Step Icon', 'designbox-builder' ),
				'type'             => Controls_Manager::ICONS,
		...
		$repeater->add_control(
			'step_text',
			[
				'label'     => esc_html__( 'Step Text', 'designbox-builder' ),
		...
		$this->add_control(
			'timelines',
			[
				'label'       => esc_html__( 'Timelines', 'designbox-builder' ),
	...
	protected function timeline_style_controls() {
		...
		$this->add_responsive_control(
			'content_wrap_space',
			[
				'label'          => esc_html__( 'Space', 'designbox-builder' ),
				'description'    => esc_html__( 'Added space between step line and content', 'designbox-builder' ),
				...
				'selectors'      => [
					'{{WRAPPER}} .wdb--timeline' => '--content-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Content bottom space', 'designbox-builder' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'default'    => [
					'unit' => 'px',
	...
	protected function content_style_controls() {
		...
		$this->add_responsive_control(
			'content_padding',
			[
				'label'      => esc_html__( 'Content padding', 'designbox-builder' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
		...
		$this->add_control(
			'heading_subtitle',
			[
				'label'     => esc_html__( 'Subtitle', 'designbox-builder' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function step_style_controls() {
		$this->start_controls_section(
			'section_step_style',
			[
				'label' => esc_html__( 'Step', 'designbox-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb--timeline' => '--icon-size: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb--timeline' => '--icon-padding: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'step_position_x',
			[
				'label'      => esc_html__( 'Step icon position-x', 'designbox-builder' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'heading_step_line',
			[
				'label'     => esc_html__( 'Step Line', 'designbox-builder' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'step_line_style',
			[
				'label'     => esc_html__( 'Line Style', 'designbox-builder' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'dashed',
				'options'   => [
					''       => esc_html__( 'Default', 'designbox-builder' ),
					'none'   => esc_html__( 'None', 'designbox-builder' ),
					'solid'  => esc_html__( 'Solid', 'designbox-builder' ),
					'dashed' => esc_html__( 'Dashed', 'designbox-builder' ),
					'dotted' => esc_html__( 'Dotted', 'designbox-builder' ),
					'double' => esc_html__( 'Double', 'designbox-builder' ),
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			'step_line_thickness',
			[
				'label'      => esc_html__( 'line Thickness', 'designbox-builder' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
	...
	protected function render() {
		...
		//wrapper class
		$this->add_render_attribute( 'wrapper', 'class', [ 'wdb--timeline', 'style-' . $settings['element_list'] ] );
