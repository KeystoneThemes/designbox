...
class Contact_Form_7 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Contact Form 7', 'designbox-builder' );
	}
	...
	public function contactform_forms() {
		...
		if ( $forms ) {
			...
			$formlist['0'] = esc_html__( 'Form not found', 'designbox-builder' );
		}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'contactform_content',
			[
				'label' => esc_html__( 'Contact Form', 'designbox-builder' ),
			]
		);
		...
		$this->add_control(
			'contact_form_id',
			[
				'label'       => esc_html__( 'Select Form', 'designbox-builder' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .wdb--form-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .wdb--form-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .wdb--form-wrapper',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb--form-wrapper' => 'text-align: {{VALUE}};',
				],
				'default'   => 'left',
				'separator' => 'before',
			]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb--form-wrapper form.wpcf7-form label' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb--form-wrapper form.wpcf7-form label' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .wdb--form-wrapper form.wpcf7-form label',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => Controls_Manager::DIMENSIONS,
				'selectors' => [
					'{{WRAPPER}} .wdb--form-wrapper form.wpcf7-form label' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .wdb--form-wrapper form.wpcf7-form label' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .wdb--form-wrapper form.wpcf7-form label' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'before',
				'options' => [
					'before'  => esc_html__( 'Before', 'designbox-builder' ),
					'after' => esc_html__( 'After', 'designbox-builder' ),
				],
	...
	protected function render() {
		...
		<div <?php $this->print_render_attribute_string( 'wrapper' ); ?> >
			...
			if ( ! empty( $settings['contact_form_id'] ) ) {
				...
				?>
                <div class="form_no_select"><?php echo esc_html__( 'Please Select contact form.', 'designbox-builder' ); ?></div>
				<?php
			}
