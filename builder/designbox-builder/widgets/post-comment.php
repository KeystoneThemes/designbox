...
class Post_Comment extends Widget_Base {
	...
	public function get_name() {
		return 'wdb--blog--post--comment';
	}

	public function get_title() {
		return esc_html__( ' Post Comment', 'designbox-builder' );
	}

	public function get_icon() {
		return 'wdb eicon-comments';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Container', 'designbox-builder' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Common Text Color', 'designbox-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'comment_ct_color',
			[
				'label'     => esc_html__( 'Comment Count', 'designbox-builder' ),
		...
		$this->add_control(
			'author_ct_color',
			[
				'label'     => esc_html__( 'Author Count', 'designbox-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'meta_ct_color',
			[
				'label'     => esc_html__( 'Date Color', 'designbox-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'c_text_color',
			[
				'label'     => esc_html__( 'Body Text', 'designbox-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Link Text', 'designbox-builder' ),
				'selector' => '{{WRAPPER}} a',
			]
		);
		...
		$this->add_control(
			'c_repluiuy_color',
			[
				'label'     => esc_html__( 'Reply Heading', 'designbox-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'c_replbtn_color',
			[
				'label'     => esc_html__( 'Reply Icon Color', 'designbox-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	------------------------------*/
		...
		$this->add_control(
			'label_show',
			[
				'label' => esc_html__( 'Show/Hide', 'designbox-builder' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Background', 'designbox-builder' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Focus Background', 'designbox-builder' ),
				'types'    => [ 'classic', 'gradient' ],
				'selector' => '
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Input Radio / Checkbox', 'designbox-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'   => esc_html__( 'Display', 'designbox-builder' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'inline-block',

				'options'   => [
					'initial'      => esc_html__( 'Initial', 'designbox-builder' ),
					'block'        => esc_html__( 'Block', 'designbox-builder' ),
					'inline-block' => esc_html__( 'Inline Block', 'designbox-builder' ),
					'flex'         => esc_html__( 'Flex', 'designbox-builder' ),
					'inline-flex'  => esc_html__( 'Inline Flex', 'designbox-builder' ),
					'none'         => esc_html__( 'none', 'designbox-builder' ),
				],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Select', 'designbox-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Textarea', 'designbox-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Expanded Height', 'designbox-builder' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Box Shadow', 'designbox-builder' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__( 'Button Floating', 'designbox-builder' ),
				...
				'options'   => [
					...
					'display:block;margin-left:auto;margin-right:auto' => [
						'title' => esc_html__( 'None', 'designbox-builder' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__( 'Text Align', 'designbox-builder' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'left'   => [
						'title' => esc_html__( 'Left', 'designbox-builder' ),
		...
		if ( ! comments_open() && ( Plugin::$instance->preview->is_preview_mode() || Plugin::$instance->editor->is_edit_mode() ) ) :
            ...
            <div class="elementor-alert elementor-alert-danger" role="alert">
				<span class="elementor-alert-title">
					<?php esc_html_e( 'Comments are closed.', 'designbox-builder' ); ?>
				</span>
                <span class="elementor-alert-description">
					<?php esc_html_e( 'Switch on comments from either the discussion box on the WordPress post edit screen or from the WordPress discussion settings.', 'designbox-builder' ); ?>
				</span>
            </div>
		<?php
		else :
