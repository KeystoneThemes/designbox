...
class Animated_Text extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Animated Text', 'designbox-builder' );
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				'name'     => 'typography',
				'selector' => '{{WRAPPER}} .wdb--text, {{WRAPPER}} .wdb--text *',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb--text a:hover,{{WRAPPER}} .wdb--text a:focus' => 'color: {{VALUE}} !important;',
				],
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'text-attr', 'class', 'wdb--text' );
