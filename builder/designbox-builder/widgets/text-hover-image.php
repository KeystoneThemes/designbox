...
class Text_Hover_Image extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Text Hover Image', 'designbox-builder' );
	}
	...
	public function get_icon() {
		return 'wdb eicon-image-rollover';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'before_hover_text',
			[
				'label'       => esc_html__( 'Before Hover Text', 'designbox-builder' ),
				...
				'placeholder' => esc_html__( 'Enter before text', 'designbox-builder' ),
				'default'     => esc_html__( 'I’m ', 'designbox-builder' ),
			]
		);
		...
		$this->add_control(
			'hover_text',
			[
				'label'       => esc_html__( 'Hover Text', 'designbox-builder' ),
				'type'        => Controls_Manager::TEXT,
				'ai'          => [
					'type' => 'text',
				],
				...
				'placeholder' => esc_html__( 'Enter hover text', 'designbox-builder' ),
				'default'     => esc_html__( 'Mariya', 'designbox-builder' ),
			]
		);
		...
		$this->add_control(
			'after_hover_text',
			[
				'label'       => esc_html__( 'After Hover Text', 'designbox-builder' ),
				'type'        => Controls_Manager::TEXT,
				'ai'          => [
					'type' => 'text',
				],
				...
				'placeholder' => esc_html__( 'Enter after text', 'designbox-builder' ),
				'default'     => esc_html__( 'the awarded dancer', 'designbox-builder' ),
			]
		);
		...
		$this->add_control(
			'image',
			[
				'label'   => esc_html__( 'Hover Image', 'designbox-builder' ),
		...
		$this->add_control(
			'title_hover_color',
			[
				'label'     => esc_html__( 'Hover Color', 'designbox-builder' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'image_position_top',
			[
				'label'      => esc_html__( 'Position Top', 'designbox-builder' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'image_position_left',
			[
				'label'      => esc_html__( 'Position Left', 'designbox-builder' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'wdb--text-hover-image' );
