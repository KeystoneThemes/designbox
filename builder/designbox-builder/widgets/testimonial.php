...
class Testimonial extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Testimonial', 'designbox-builder' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'element_list',
			[
				'label'   => esc_html__( 'Testimonial Style', 'designbox-builder' ),
				...
				'options' => [
					...
					'6'  => esc_html__( 'Six', 'designbox-builder' ),
					'7'  => esc_html__( 'Seven', 'designbox-builder' ),
					'8'  => esc_html__( 'Eight', 'designbox-builder' ),
					'9'  => esc_html__( 'Nine', 'designbox-builder' ),
					'10' => esc_html__( 'Ten', 'designbox-builder' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb__testimonial .ts-navigation' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial .ts-pagination' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial .image:after' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial .wdb-arrow-next, {{WRAPPER}} .wdb__testimonial .wdb-arrow-prev' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial .mid-line' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .wdb__testimonial:before,{{WRAPPER}} .wdb__testimonial:after' => 'background-color: {{VALUE}}',
				],
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper',
			[
				'class'         => [ 'wdb__t_slider-wrapper wdb__testimonial', 'style-' . $settings['element_list'] ],
