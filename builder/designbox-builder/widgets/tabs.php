...
class Tabs extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Tabs', 'designbox-builder' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Tab Title', 'designbox-builder' ),
				'placeholder' => esc_html__( 'Tab Title', 'designbox-builder' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$repeater->add_control(
			'tabs_content_type',
			[
				'label'   => esc_html__('Content Type', 'designbox-builder'),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'content'  => esc_html__('Content', 'designbox-builder'),
					'template' => esc_html__('Saved Templates', 'designbox-builder'),
				],
				'default' => 'content',
			]
		);
		...
		$repeater->add_control(
			'elementor_templates',
			[
				'label'       => esc_html__( 'Save Template', 'designbox-builder' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Tab Content', 'designbox-builder' ),
				'placeholder' => esc_html__( 'Tab Content', 'designbox-builder' ),
		...
		$this->add_control(
			'tabs',
			[
				'label'       => esc_html__( 'Tabs Items', 'designbox-builder' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'default'     => [
					[
						'tab_title'   => esc_html__( 'Tab Title 1', 'designbox-builder' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'designbox-builder' ),
					],
					[
						'tab_title'   => esc_html__( 'Tab Title 2', 'designbox-builder' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'designbox-builder' ),
					],
					[
						'tab_title'   => esc_html__( 'Tab Title 3', 'designbox-builder' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'designbox-builder' ),
					],
				],
		...
		$this->add_control(
			'view',
			[
				'label'   => esc_html__( 'View', 'designbox-builder' ),
		...
		$this->add_control( 'tabs_direction',
			[
				...
				'options'      => [
					'column'         => [
						'title' => esc_html__( 'Above', 'designbox-builder' ),
						'icon'  => 'eicon-v-align-top',
					],
					'column-reverse' => [
						'title' => esc_html__( 'Below', 'designbox-builder' ),
						'icon'  => 'eicon-v-align-bottom',
					],
					'row-reverse'    => [
						'title' => esc_html__( 'After', 'designbox-builder' ),
						'icon'  => 'eicon-h-align-' . $end,
					],
					'row'            => [
						'title' => esc_html__( 'Before', 'designbox-builder' ),
		...
		$this->add_control(
			...
			[
				...
				'type'         => Controls_Manager::SELECT,
				'options'      => [
					''        => esc_html__( 'Start', 'designbox-builder' ),
					'center'  => esc_html__( 'Center', 'designbox-builder' ),
					'end'     => esc_html__( 'End', 'designbox-builder' ),
					'stretch' => esc_html__( 'Stretch', 'designbox-builder' ),
				],
				'selectors'    => [
		...
		$this->add_responsive_control(
			'tab_tittle_align',
			[
				'label'     => esc_html__( 'Title Alignment', 'designbox-builder' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'start'  => [
		...
		$this->add_control(
			...
			[
				...
				'type'         => Controls_Manager::SELECT,
				'description'  => esc_html__( 'Note: Choose at which breakpoint tabs will automatically switch to a vertical (“accordion”) layout.', 'designbox-builder' ),
		...
		$this->add_control(
			'navigation_width',
			[
				'label'     => esc_html__( 'Navigation Width', 'designbox-builder' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'unit' => '%',
				],
		...
		$this->add_responsive_control( 'tabs_title_space_between',
			[
				'label'      => esc_html__( 'Gap between tabs', 'designbox-builder' ),
				'separator'  => 'before',
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control( 'tabs_title_spacing',
			[
				'label'      => esc_html__( 'Distance from content', 'designbox-builder' ),
				'type'       => Controls_Manager::SLIDER,
				'separator'  => 'after',
				'range'      => [
					'px' => [
		...
		$this->start_controls_tab(
			'tab_title_hover',
			[
				'label' => esc_html__( 'Hover/Active', 'designbox-builder' ),
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'wdb--tabs' );
		?>
