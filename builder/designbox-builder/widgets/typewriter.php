...
class Typewriter extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Typewriter', 'designbox-builder' );
	}
	...
	public function get_icon() {
		return 'wdb eicon-animation-text';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'Non-Animated Text', 'designbox-builder' ),
				...
				'default' => esc_html__( 'A Web', 'designbox-builder' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Animated Text List', 'designbox-builder' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'default'     => [
					[
						'list_text' => esc_html__( 'Designer', 'designbox-builder' ),
					],
					[
						'list_text' => esc_html__( 'Developer', 'designbox-builder' ),
					],
					[
						'list_text' => esc_html__( 'programmer', 'designbox-builder' ),
					],
				],
	...
	protected function render() {
		...
		$this->add_render_attribute( 'typewriter-attr', 'class', 'wdb--typewriter' );
