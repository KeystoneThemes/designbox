...
class Progressbar extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Progressbar', 'designbox-builder' );
	}
	...
	public function get_script_depends() {
		return [ 'elementor-waypoints', 'progressbar', 'wdb--progressbar' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_progressbar',
			[
				'label' => esc_html__( 'Progress Bar', 'designbox-builder' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'percentage',
			[
				'label'      => esc_html__( 'Percentage', 'designbox-builder' ),
		...
		$this->add_control(
			'display_percentage',
			[
				'label'        => esc_html__( 'Display Percentage', 'designbox-builder' ),
		...
		$this->add_control(
			...
			[
				...
				'default'     => '#7DDED8',
				'selectors'   => [
					'{{WRAPPER}} .wdb__progressbar.style-3 .dot' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'render_type' => 'template',
				'selectors'   => [
					'{{WRAPPER}} .wdb__progressbar.style-3 .dot.active' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .wdb__progressbar.style-3 .dot' => 'border-width: {{SIZE}}{{UNIT}};',
				],
				'condition'   => [ 'element_list' => '3' ],
			]
		);
		...
		$this->add_control(
			'stroke-width',
			[
				'label'       => esc_html__( 'Stroke Width', 'designbox-builder' ),
				'type'        => Controls_Manager::SLIDER,
				'render_type' => 'template',
				'size_units'  => [ 'em' ],
				'default'     => [
		...
		$this->add_control(
			'trail-width',
			[
				'label'       => esc_html__( 'Trail Width', 'designbox-builder' ),
				'type'        => Controls_Manager::SLIDER,
				'render_type' => 'template',
				'size_units'  => [ 'em' ],
				'default'     => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units'  => [ 'px' ],
				'selectors'   => [
					'{{WRAPPER}} .wdb__progressbar.style-2, {{WRAPPER}} .wdb__progressbar.style-3 .dot ' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
		...
		$this->add_control(
			'percentage_position',
			[
				'label'      => esc_html__( 'Position Y', 'designbox-builder' ),
				'type'       => Controls_Manager::SLIDER,
				'default'    => [
					'unit' => 'px',
					'size' => - 30,
				...
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} .wdb__progressbar.style-1 .progressbar-text' => 'top: {{SIZE}}{{UNIT}} !important;',
				],
				'condition'  => [ 'element_list' => '1' ],
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper',
			[
				'class'         => 'wdb__progressbar style-' . $settings['element_list'],
