...
class Skin_Pricing_Table_1 extends Skin_Pricing_Table_Base {
	...
	public function get_title() {
		return __( 'Style 1', 'wdb-addons-pro' );
	}
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/wdb--a-pricing-table/section_header/before_section_end', [
			$this,
			'inject_header_controls'
		] );

		add_action( 'elementor/element/wdb--a-pricing-table/section_header_style/before_section_end', [
			$this,
	...
	public function injects_header_style() {
		...
		$this->add_control(
			'title_bg_color',
			[
				'label'     => esc_html__( 'Header Top Background', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'separator' => 'before',
				'selectors' => [
	...
	public function register_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Items Order', 'wdb-addons-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'header_price_order',
			[
				'label' => esc_html__( 'Header & Pricing', 'wdb-addons-pro' ),
		...
		$this->add_control(
			'feature_list_order',
			[
				'label' => esc_html__( 'Feature', 'wdb-addons-pro' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 1,
				'max' => 3,
				'default' => 2,
	...
	public function render() {
		...
		$this->parent->add_render_attribute( 'wrapper', 'class', 'wdb__priceTable '. $this->get_id() );
