...
abstract class Skin_Pricing_Table_Base extends Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/wdb--a-pricing-table/section_layout/after_section_end', [ $this, 'register_controls' ] );
	}
	...
	protected function render_button( $settings = [], $setting = null, $repeater_name = null, $index = null ) {
		...
		$this->parent->add_render_attribute( 'button_wrapper', 'class', 'wdb__btn' );
		$this->parent->add_render_attribute( $link_key, 'class', 'wdb-btn-' . $settings['btn_element_list'] );
