...
class Image_Accordion extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Image Accordion', 'wdb-addons-pro' );
	}
	...
	public function get_style_depends() {
		return [ 'wdb--image-accordion', 'wdb--button' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Image Accordion', 'wdb-addons-pro' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'               => Controls_Manager::SELECT,
				'separator'          => 'before',
				'description'        => esc_html__( 'Note: Choose at which breakpoint will Show Vertically.', 'wdb-addons-pro' ),
		...
		$this->add_control(
			'expand_style',
			[
				'label'              => esc_html__( 'Expand On', 'wdb-addons-pro' ),
				'type'               => Controls_Manager::SELECT,
				'default'            => 'hover',
				'frontend_available' => true,
				'options'            => [
					'hover' => esc_html__( 'Hover', 'wdb-addons-pro' ),
					'click' => esc_html__( 'Click', 'wdb-addons-pro' ),
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb__image-accordion' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function register_image_accordions_content() {
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Siyantika Glory', 'wdb-addons-pro' ),
				'placeholder' => esc_html__( 'Type your title', 'wdb-addons-pro' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Modelling - 2012', 'wdb-addons-pro' ),
				'placeholder' => esc_html__( 'Type your sub title', 'wdb-addons-pro' ),
			]
		);
		// Description
		$repeater->add_control(
			'description',
			[
				'label'       => esc_html__( 'Description', 'wdb-addons-pro' ),
				'type'        => Controls_Manager::TEXTAREA,
				'rows'        => 10,
				'default'     => esc_html__( 'Hatha yoga built on a harmonious balance between body strength and softness', 'wdb-addons-pro' ),
				'placeholder' => esc_html__( 'Type your description', 'wdb-addons-pro' ),
			]
		);
		...
		$this->add_control(
			'accordions',
			[
				'label'   => esc_html__( 'Accordions', 'wdb-addons-pro' ),
	...
	protected function register_content_style_controls() {
		...
		$this->add_control(
			'overlay_color',
			[
				'label' => esc_html__( 'Overlay Color', 'wdb-addons-pro' ),
		...
		$this->add_responsive_control(
			'title_hover_space',
			[
				'label'     => esc_html__( 'Hover Spacing', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => -200,
