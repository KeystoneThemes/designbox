...
class Scroll_Elements extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Scroll Elements', 'wdb-addons-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Scroll Contents', 'wdb-addons-pro' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Scroll Title', 'wdb-addons-pro' ),
				'separator' => 'after',
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Tab Content', 'wdb-addons-pro' ),
		...
		$this->add_control(
			'scroll_items',
			[
				'label'       => esc_html__( 'Scroll Items', 'wdb-addons-pro' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'default'     => [
					[
						'scroll_title'   => esc_html__( 'Scroll Title 1', 'wdb-addons-pro' ),
						'scroll_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'wdb-addons-pro' ),
					],
					[
						'scroll_title'   => esc_html__( 'Scroll Title 2', 'wdb-addons-pro' ),
						'scroll_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'wdb-addons-pro' ),
					],
					[
						'scroll_title'   => esc_html__( 'Scroll Title 3', 'wdb-addons-pro' ),
						'scroll_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'wdb-addons-pro' ),
					],
				],
		...
		$this->add_control(
			'show_navigation',
			[
				'label'        => esc_html__( 'Show Navigation/Title', 'wdb-addons-pro' ),
		...
		$this->add_control(
			'show_image',
			[
				'label'        => esc_html__( 'Show Image', 'wdb-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'wdb-addons-pro' ),
				'label_off'    => esc_html__( 'Hide', 'wdb-addons-pro' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'type'         => Controls_Manager::SELECT,
				'description'  => esc_html__( 'Note: Choose at which breakpoint Scroll navigation and Image will automatically display None.', 'wdb-addons-pro' ),
				'options'      => $dropdown_options,
				'default'      => 'mobile',
				'prefix_class' => 'wdb-scroll-',
			]
		);
	...
	protected function register_navigation_controls() {
		...
		$this->start_controls_section(
			'section_scroll_nav',
			[
				'label'     => esc_html__( 'Scroll Navigation/Title', 'wdb-addons-pro' ),
		...
		$this->add_responsive_control(
			'scroll_tittle_align',
			[
				'label'     => esc_html__( 'Navigation Alignment', 'wdb-addons-pro' ),
		...
		$this->add_control( 'scroll_navigation_direction',
			[
				'label'     => esc_html__( 'Navigation Direction', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'row-reverse' => [
						'title' => esc_html__( 'After', 'wdb-addons-pro' ),
						'icon'  => 'eicon-h-align-right'
					],
					'row'         => [
						'title' => esc_html__( 'Before', 'wdb-addons-pro' ),
						'icon'  => 'eicon-h-align-left'
					],
				],
				'selectors' => [
					'{{WRAPPER}} .wdb--scroll-elements' => 'flex-direction: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					''              => esc_html__( 'Start', 'wdb-addons-pro' ),
					'center'        => esc_html__( 'Center', 'wdb-addons-pro' ),
					'end'           => esc_html__( 'End', 'wdb-addons-pro' ),
					'space-between' => esc_html__( 'Space Between', 'wdb-addons-pro' ),
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb--scroll-elements' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function register_navigation_style_controls() {
		...
		$this->add_responsive_control( 'scroll_title_space_between',
			[
				'label'      => esc_html__( 'Gap between Titles', 'wdb-addons-pro' ),
				'separator'  => 'before',
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'title_icon_margin',
			[
				'label'      => esc_html__( 'Icon Margin', 'wdb-addons-pro' ),
		...
		$this->start_controls_tab(
			'scroll_title_hover',
			[
				'label' => esc_html__( 'Hover/Active', 'wdb-addons-pro' ),
			]
		);
	...
	protected function register_scroll_image_style_controls() {
		...
		$this->add_control( 'image_direction',
			[
				'label'     => esc_html__( 'Image Direction', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'row-reverse' => [
						'title' => esc_html__( 'After', 'wdb-addons-pro' ),
