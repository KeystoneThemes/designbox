...
class Toggle_Switcher extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Toggle Switch', 'wdb-addons-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Toggle Switch', 'wdb-addons-pro' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => '1',
				'options' => [
					'1' => esc_html__( 'One', 'wdb-addons-pro' ),
					'2' => esc_html__( 'Two', 'wdb-addons-pro' ),
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Monthly', 'wdb-addons-pro' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'   => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'wdb-addons-pro' ),
		...
		$this->add_control(
			'toggle_switcher',
			[
				'label'        => esc_html__( 'Toggle Switcher', 'wdb-addons-pro' ),
		...
		$this->add_responsive_control(
			'toggle_bottom_space',
			[
				'label'      => esc_html__( 'Bottom Space', 'wdb-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'separator'  => 'before',
				'range'      => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Switcher Wrapper', 'wdb-addons-pro' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Switcher', 'wdb-addons-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
		...
		$this->add_control(
			'switcher_background',
			[
				'label'     => esc_html__( 'Background', 'wdb-addons-pro' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Active Background', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'indicator_heading',
			[
				'label'     => esc_html__( 'Indicator', 'wdb-addons-pro' ),
		...
		$this->add_control(
			...
			[
				'label'      => esc_html__( 'Indicator Size', 'wdb-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label'      => esc_html__( 'Indicator Space', 'wdb-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Active Title', 'wdb-addons-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
