...
class Filterable_Gallery extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Filterable Gallery', 'wdb-addons-pro' );
	}
	...
	protected function register_layout_controls() {
		...
		$this->add_control(
			'layout_style',
			[
				'label'   => esc_html__( 'Style', 'wdb-addons-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'grid',
				'options' => [
					'grid'    => esc_html__( 'Grid', 'wdb-addons-pro' ),
					'masonry' => esc_html__( 'Masonry', 'wdb-addons-pro' ),
				],
			]
		);
		...
		$this->add_responsive_control(
			'row_height',
			[
				'label'      => esc_html__( 'Row Height', 'wdb-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'range'      => [
					'px' => [
	...
	protected function register_filter_controls() {
		$this->start_controls_section(
			'section_filter',
			[
				'label' => __( 'Filter', 'wdb-addons-pro' ),
			]
		);
		...
		$this->add_control(
			'enable_filter',
			[
				'label'        => esc_html__( 'Enable Filter', 'wdb-addons-pro' ),
		...
		$this->add_control(
			'filter_all_label',
			[
				'label'     => esc_html__( 'Filter All Label', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => esc_html__( 'All', 'wdb-addons-pro' ),
		...
		$filter_repeater->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Filter Item', 'wdb-addons-pro' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$this->add_control(
			'filter_items',
			[
				'label'       => esc_html__( 'Filter Items', 'wdb-addons-pro' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $filter_repeater->get_controls(),
				'condition'   => [ 'enable_filter' => 'yes' ],
				'default'     => [
					[
						'filter_title' => esc_html__( 'Filter Item 1', 'wdb-addons-pro' ),
					],
				],
	...
	protected function register_gallery_controls() {
		$this->start_controls_section(
			'section_gallery',
			[
				'label' => __( 'Gallery', 'wdb-addons-pro' ),
			]
		);
		...
		$gallery_repeater->add_control(
			...
			[
				'label'       => esc_html__( 'Filter name', 'wdb-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'Use the filter name. Separate multiple items with comma (e.g. <strong>Gallery Item, Gallery Item 2</strong>)', 'wdb-addons-pro' ),
				'separator'   => 'after',
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
		...
		$gallery_repeater->add_control(
			...
			[
				'label'   => esc_html__( 'Type', 'wdb-addons-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'image',
				'options' => [
					'image' => esc_html__( 'Image', 'wdb-addons-pro' ),
					'video' => esc_html__( 'Video', 'wdb-addons-pro' ),
					'audio' => esc_html__( 'Audio', 'wdb-addons-pro' ),
				],
			]
		);
		...
		$gallery_repeater->add_control(
			...
			[
				'label'       => esc_html__( 'Video/audio Link', 'wdb-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
		...
		$gallery_repeater->add_control(
			'play_btn_icon',
			[
				'label'       => esc_html__( 'Play Icon', 'wdb-addons-pro' ),
		...
		$gallery_repeater->add_control(
			...
			[
				'label'        => esc_html__( 'Lightbox', 'wdb-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'wdb-addons-pro' ),
				'label_off'    => esc_html__( 'Hide', 'wdb-addons-pro' ),
				'return_value' => 'yes',
		...
		$gallery_repeater->add_control(
			'masonry_style',
			[
				'label'       => esc_html__( 'Masonry Class', 'wdb-addons-pro' ),
				'description' => esc_html__( 'Its only work for masonry layout.', 'wdb-addons-pro' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => '',
				'options'     => [
					''           => esc_html__( 'Default', 'wdb-addons-pro' ),
					'big'        => esc_html__( 'Big', 'wdb-addons-pro' ),
					'horizontal' => esc_html__( 'Horizontal', 'wdb-addons-pro' ),
					'vertical'   => esc_html__( 'Vertical', 'wdb-addons-pro' ),
				],
				'selectors'   => [
		...
		$this->add_control(
			'gallery_items',
			[
				'label'       => esc_html__( 'Gallery Items', 'wdb-addons-pro' ),
				'type'        => Controls_Manager::REPEATER,
		...
		$this->add_control(
			'play_button_heading',
			[
				'label'     => esc_html__( 'Play Button', 'wdb-addons-pro' ),
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', [
				'class' => 'wdb--filterable-gallery ' . 'style-' . $settings['layout_style'],
			]
		);
		?>
