...
class Skin_Portfolio_Seven extends Skin_Portfolio_Base {
	...
	public function get_title() {
		return __( 'Portfolio Seven', 'wdb-addons-pro' );
	}
	...
	public function register_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			'thumb_slider_width',
			[
				'label'      => esc_html__( 'Thumb slider width', 'wdb-addons-pro' ),
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb__thumb-slider-wrapper' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'thumb_slider_height',
			[
				'label'      => esc_html__( 'Thumb slider Height', 'wdb-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem', 'vh', 'custom' ],
				'range'      => [
					'px' => [
		...
		$this->add_control( 'thumb_slider_direction',
			[
				'label'     => esc_html__( 'Thumb slider direction', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'row-reverse' => [
						'title' => esc_html__( 'After', 'wdb-addons' ),
						'icon'  => 'eicon-h-align-left',
					],
					'row'         => [
						'title' => esc_html__( 'Before', 'wdb-addons' ),
						'icon'  => 'eicon-h-align-right',
					],
				],
				'selectors' => [
					'{{WRAPPER}} .wdb--advance-portfolio.skin-portfolio-seven' => 'flex-direction: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'icon_rotate',
			[
				'label'     => esc_html__( 'Rotate', 'wdb-addons-por' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => - 360,
	...
	protected function register_slider_controls( $default_value = [] ) {
		...
		$this->update_control(
			'slides_to_show',
			[
				'label'       => esc_html__( 'Thumb Slides to Show', 'wdb-addons-pro' ),
		...
		$this->add_responsive_control(
			'thumb_display',
			[
				'label'          => esc_html__( 'Thumb Slider Display', 'wdb-addons-pro' ),
				'type'           => Controls_Manager::SELECT,
				'separator'      => 'before',
				'default'        => 'block',
				'mobile_default' => 'none',
				'options'        => [
					'block' => esc_html__( 'Block', 'wdb-addons-pro' ),
					'none'  => esc_html__( 'None', 'wdb-addons-pro' ),
				],
				'selectors'      => [
					'{{WRAPPER}} .wdb__thumb-slider-wrapper' => 'display: {{VALUE}};',
				],
			]
		);
