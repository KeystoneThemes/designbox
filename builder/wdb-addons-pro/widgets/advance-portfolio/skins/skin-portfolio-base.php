<?php
namespace WDBAddonsPro\Widgets\Skin;
...
abstract class Skin_Portfolio_Base extends Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/wdb--a-portfolio/section_layout/after_section_end', [ $this, 'register_controls' ] );
	}
	...
	protected function register_date_controls() {
		$this->start_controls_section(
			'section_date_style',
			[
				'label' => esc_html__( 'Date', 'wdb-addons-pro' ),
	...
	protected function register_meta_controls() {
		$this->start_controls_section(
			'section_meta',
			[
				'label' => esc_html__( 'Meta', 'wdb-addons-pro' ),
			]
		);
		$this->add_control(
			'post_taxonomy',
			[
				'label'       => esc_html__( 'Taxonomy', 'wdb-addons-pro' ),
	...
	protected function register_slider_controls( $default_value = [] ) {
		...
		$this->add_responsive_control(
			'slides_to_show',
			[
				'label'       => esc_html__( 'Slides to Show', 'wdb-addons-pro' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => $default['slides_to_show'],
				'required'    => true,
				'options'     => [
					                 'auto' => esc_html__( 'Auto', 'wdb-addons-pro' ),
				                 ] + $slides_to_show,
		...
		$this->add_control(
			'autoplay',
			[
				'label'   => esc_html__( 'Autoplay', 'wdb-addons-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => $default['autoplay'],
				'options' => [
					'yes' => esc_html__( 'Yes', 'wdb-addons-pro' ),
					'no'  => esc_html__( 'No', 'wdb-addons-pro' ),
				],
			]
		);
		...
		$this->add_control(
			'autoplay_delay',
			[
				'label'     => esc_html__( 'Autoplay delay', 'wdb-addons-pro' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Autoplay Interaction', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => $default['autoplay_interaction'],
				'options'   => [
					'true'  => esc_html__( 'Yes', 'wdb-addons-pro' ),
					'false' => esc_html__( 'No', 'wdb-addons-pro' ),
				],
				'condition' => [
					'autoplay' => 'yes',
				],
		...
		$this->add_control(
			'allow_touch_move',
			[
				'label'     => esc_html__( 'Allow Touch Move', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::SELECT,
				'separator' => 'before',
		...
		$this->add_control(
			'loop',
			[
				'label'   => esc_html__( 'Loop', 'wdb-addons-pro' ),
				'type'    => Controls_Manager::SELECT,
		...
		$this->add_control(
			'mousewheel',
			[
				'label'       => esc_html__( 'Mousewheel', 'wdb-addons-pro' ),
				'description' => esc_html__( 'If you want to use mousewheel, please disable loop.', 'wdb-addons-pro' ),
		...
		$this->add_control(
			'speed',
			[
				'label'   => esc_html__( 'Animation Speed', 'wdb-addons-pro' ),
				'type'    => Controls_Manager::NUMBER,
		...
		$this->add_control(
			'space_between',
			[
				'label'       => esc_html__( 'Space Between', 'wdb-addons-pro' ),
				'type'        => Controls_Manager::NUMBER,
		...
		$this->add_control(
			'effect',
			[
				'label'   => esc_html__( 'Effect', 'wdb-addons-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => $default['effect'],
				'options' => [
					'slide'  => esc_html__( 'Slide', 'wdb-addons-pro' ),
					'fade'  => esc_html__( 'Fade', 'wdb-addons-pro' ),
					'coverflow' => esc_html__( 'Coverflow', 'wdb-addons-pro' ),
					'flip' => esc_html__( 'Flip', 'wdb-addons-pro' ),
					'cube' => esc_html__( 'Cube', 'wdb-addons-pro' ),
				],
			]
		);
		...
		$this->add_control(
			'navigation',
			[
				'label'     => esc_html__( 'Navigation', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'separator' => 'before',
				'label_on'  => esc_html__( 'Show', 'wdb-addons-pro' ),
				'label_off' => esc_html__( 'Hide', 'wdb-addons-pro' ),
		...
		$this->add_control(
			...
			[
				'label'            => esc_html__( 'Previous Arrow Icon', 'wdb-addons-pro' ),
		...
		$this->add_control(
			...
			[
				'label'            => esc_html__( 'Next Arrow Icon', 'wdb-addons-pro' ),
				'type'             => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'skin'             => 'inline',
				'label_block'      => false,
		...
		$this->add_control(
			'pagination',
			[
				'label'     => esc_html__( 'Pagination', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'separator' => 'before',
				'label_on'  => esc_html__( 'Show', 'wdb-addons-pro' ),
				'label_off' => esc_html__( 'Hide', 'wdb-addons-pro' ),
		...
		$this->add_control(
			'pagination_type',
			[
				'label'     => esc_html__( 'Pagination Type', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => $default['pagination_type'],
				'options'   => [
					'bullets'     => esc_html__( 'Bullets', 'wdb-addons-pro' ),
					'fraction'    => esc_html__( 'Fraction', 'wdb-addons-pro' ),
					'progressbar' => esc_html__( 'Progressbar', 'wdb-addons-pro' ),
				],
				'condition'        => [
		...
		$this->add_control(
			'direction',
			[
				'label'     => esc_html__( 'Direction', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::SELECT,
				'separator' => 'before',
				'default'   => $default['direction'],
				'options'   => [
					'ltr' => esc_html__( 'Left', 'wdb-addons-pro' ),
					'rtl' => esc_html__( 'Right', 'wdb-addons-pro' ),
				],
			]
		);
	}
	...
	protected function register_slider_pagination_style_controls( $default_selectors = [] ) {
		...
		$this->add_control(
			'bullets_color',
			[
				'label'     => esc_html__( 'Active Color', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'fraction_current_color',
			[
				'label'     => esc_html__( 'Current Color', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'fraction_total_color',
			[
				'label'     => esc_html__( 'Total Color', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'fraction_midline_color',
			[
				'label'     => esc_html__( 'Mid Line Color', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'progress_color',
			[
				'label'     => esc_html__( 'Progressbar Color', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'progress_fill_color',
			[
				'label'     => esc_html__( 'Progressbar Fill Color', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
	...
	protected function get_slider_attributes( ) {
		...
		if ( ! empty( $this->get_instance_value('navigation') ) ) {
			$slider_settings['navigation'] = [
				'nextEl' => '.elementor-element-' . $this->parent->get_id() . ' .wdb-arrow-next',
				'prevEl' => '.elementor-element-' . $this->parent->get_id() . ' .wdb-arrow-prev',
			];
		}
