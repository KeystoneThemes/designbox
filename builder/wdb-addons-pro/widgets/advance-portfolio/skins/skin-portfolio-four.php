...
class Skin_Portfolio_Four extends Skin_Portfolio_Base {
	...
	public function get_title() {
		return __( 'Portfolio Four', 'wdb-addons-pro' );
	}
	...
	protected function register_layout_style_controls() {
		...
		$this->add_responsive_control(
			'layout_column',
			[
				'label' => esc_html__( 'Column', 'wdb-addons-pro' ),
				'type' => Controls_Manager::SELECT,
				'default' => '3',
				'options' => [
					'1' => esc_html__( '1', 'wdb-addons-pro' ),
					'2' => esc_html__( '2', 'wdb-addons-pro' ),
					'3' => esc_html__( '3', 'wdb-addons-pro' ),
					'4' => esc_html__( '4', 'wdb-addons-pro' ),
					'5' => esc_html__( '5', 'wdb-addons-pro' ),
					'6' => esc_html__( '6', 'wdb-addons-pro' ),
				],
				'selectors' => [
		...
		$this->add_control(
			'item_heading',
			[
				'label' => esc_html__( 'Item', 'wdb-addons-pro' ),
