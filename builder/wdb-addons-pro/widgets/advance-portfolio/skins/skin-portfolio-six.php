...
class Skin_Portfolio_Six extends Skin_Portfolio_Base {
	...
	public function get_title() {
		return __( 'Portfolio Six', 'wdb-addons-pro' );
	}
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/wdb--a-portfolio/section_title_style/before_section_end', [ $this, 'inject_controls' ] );
	}
	...
	public function inject_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Slide Title', 'wdb-addons-pro' ),
