...
class Skin_Portfolio_Nine extends Skin_Portfolio_Base {
	...
	public function get_title() {
		return __( 'Portfolio Nine', 'wdb-addons-pro' );
	}
	...
	public function inject_controls() {
		...
		$this->add_control(
			'section_description',
			[
				'label'   => esc_html__( 'Section Description', 'wdb-addons-pro' ),
				'type'    => Controls_Manager::TEXTAREA,
				'rows'    => 5,
				'default' => esc_html__( 'View the full case study of our recent featured and awesome works that we created for our clients.', 'wdb-addons-pro' ),
			]
		);
	...
	protected function register_layout_style_controls() {
		...
		$this->add_responsive_control( 'layout_direction',
            [
				...
				'options'   => [
					...
					'column'         => [
						'title' => esc_html__( 'Column - vertical', 'wdb-addons-pro' ),
					...
					'column-reverse' => [
						'title' => esc_html__( 'Column - reversed', 'wdb-addons-pro' ),
						'icon'  => 'eicon-arrow-up',
					],
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Header margin', 'wdb-addons-pro' ),
	...
	protected function register_section_pagination_style_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Current', 'wdb-addons-pro' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Total', 'wdb-addons-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
