...
class Skin_Portfolio_Three extends Skin_Portfolio_Base {
	...
	public function get_title() {
		return __( 'Portfolio Three', 'wdb-addons-pro' );
	}
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/wdb--a-portfolio/section_layout/before_section_end', [ $this, 'inject_controls' ] );
	}
	...
	public function inject_controls() {
		...
		$this->add_control(
			'section_title',
			[
				'label'     => esc_html__( 'Section Title', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::TEXT,
				'separator' => 'before',
				'default'   => esc_html__( 'WORK', 'wdb-addons-pro' ),
			]
		);
		...
		$this->add_control(
			'section_title_tag',
			[
				'label' => esc_html__( 'Section Title Tag', 'wdb-addons-pro' ),
	...
	protected function register_layout_style_controls() {
		...
		$this->add_responsive_control(
			'layout_column_gap',
			[
				'label'      => esc_html__( 'Column Gap', 'wdb-addons-pro' ),
		...
		$this->add_responsive_control(
			'layout_row_gap',
			[
				'label'      => esc_html__( 'Row Gap', 'wdb-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
	...
	protected function register_section_animation_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Animations', 'wdb-addons-pro' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'              => esc_html__( 'Enable Editor Mode', 'wdb-addons-pro' ),
				'type'               => Controls_Manager::SWITCHER,
				'return_value'       => 'yes',
				'condition'          => [
		...
		$this->add_control(
			'wdb_apf_pin_area_start',
			[
				'label' => esc_html__( 'Title Pin Area Start', 'wdb-addons-pro' ),
				'description'        => esc_html__( 'First value is element position, Second value is display position', 'wdb-addons-pro' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'top top', 'wdb-addons-pro' ),
				'placeholder' => esc_html__( 'top top', 'wdb-addons-pro' ),
				'condition'          => [
					$this->get_control_id( 'enable_apf_animation!' ) => ''
				],
			]
		...
		$this->add_control(
			'wdb_apf_pin_area_end',
			[
				'label' => esc_html__( 'Title Pin Area End', 'wdb-addons-pro' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'bottom bottom', 'wdb-addons-pro' ),
				'placeholder' => esc_html__( 'bottom bottom', 'wdb-addons-pro' ),
				'condition'          => [
					$this->get_control_id( 'enable_apf_animation!' ) => ''
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'type'               => Controls_Manager::SELECT,
				'description'        => esc_html__( 'Note: Choose at which breakpoint Pin element will work.', 'wdb-addons-pro' ),
	...
	protected function get_animation_settings() {
		return [
			...
			'pin_area_start' => $this->get_instance_value( 'wdb_apf_pin_area_start' ),
			'pin_area_end'   => $this->get_instance_value( 'wdb_apf_pin_area_end' ),
			'breakpoint'     => $this->get_instance_value( 'wdb_apf_breakpoint' ),
			'skin'           => $this->get_id(),
		];
	}
	...
	public function render() {
		$this->parent->add_render_attribute(
			'wrapper',
			[
				'class' => [ 'wdb--advance-portfolio ' . $this->get_id() ],
