...
class Skin_Portfolio_two extends Skin_Portfolio_Base {
	...
	public function get_title() {
		return __( 'Portfolio Two', 'wdb-addons-pro' );
	}
	...
	public function register_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Slider', 'wdb-addons-pro' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'   => [
					'row'         => [
						'title' => esc_html__( 'Row - horizontal', 'wdb-addons-pro' ),
						'icon'  => 'eicon-arrow-right',
					],
					'row-reverse' => [
						'title' => esc_html__( 'Row - reversed', 'wdb-addons-pro' ),
						'icon'  => 'eicon-arrow-left',
					],
				],
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .wdb--advance-portfolio' => 'flex-direction: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'sliders_align',
			[
				'label'     => esc_html__( 'Align Items', 'wdb-addons-pro' ),
				'type'      => Controls_Manager::CHOOSE,
				'default'   => '',
				'options'   => [
					'flex-start' => [
						'title' => esc_html__( 'Start', 'wdb-addons-pro' ),
					...
					'flex-end'   => [
						'title' => esc_html__( 'End', 'wdb-addons-pro' ),
						'icon'  => 'eicon-flex eicon-align-end-v',
					],
				],
				'selectors' => [
					'{{WRAPPER}} .wdb--advance-portfolio' => 'align-items: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wdb--advance-portfolio' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Slider Wrapper', 'wdb-addons-pro' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .main-slider .wdb__slider' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Navigation', 'wdb-addons-pro' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Slider Pagination', 'wdb-addons-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
		...
		$this->add_responsive_control(
			'pagination_gap',
			[
				'label' => esc_html__( 'Spacing', 'wdb-addons-pro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Content', 'wdb-addons-pro' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors'      => [
					'{{WRAPPER}} .wdb__thumb-slider-wrapper' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'toggle' => true,
				'selectors' => [
					'{{WRAPPER}} .wdb__thumb_slider .swiper-slide' => 'text-align: {{VALUE}}; justify-content: {{VALUE}}',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function register_slider_controls( $default_value = [] ) {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'cards'    => esc_html__( 'Cards', 'wdb-addons-pro' ),
					'flip'     => esc_html__( 'Flip', 'wdb-addons-pro' ),
					'creative' => esc_html__( 'Creative', 'wdb-addons-pro' ),
				],
			]
		);
		...
		$this->add_control(
			'grab_cursor',
			[
				'label'        => esc_html__( 'grab Cursor', 'wdb-addons-pro' ),
	...
	protected function get_thumb_slider_attributes( ) {
		...
		$this->parent->add_render_attribute(
			...
			[
				'class'        => 'wdb__thumb_slider ' . $swiper_class,
				'thumbsSlider' => " ",
				'style'        => 'position: static',
			]
		);
	...
	public function render() {
		...
		$this->parent->add_render_attribute(
			'wrapper',
			[
				'class'         => [ 'wdb__slider-wrapper wdb--advance-portfolio ' . $this->get_id() ],
		...
		$this->parent->add_render_attribute(
			'thumb-wrapper',
			[
				'class'         => [ 'wdb__thumb-slider-wrapper ' ],
