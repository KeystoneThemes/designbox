...
class Portfolio extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Portfolio', 'wdb-addons' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_layout',
			[
				'label' => esc_html__( 'Layout', 'wdb-addons' ),
		...
		$this->add_control(
			'element_list',
			[
				'label'   => esc_html__( 'Style', 'wdb-addons' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '1',
				'options' => [
					'1' => esc_html__( 'One', 'wdb-addons' ),
					'2' => esc_html__( 'Two', 'wdb-addons' ),
					'3' => esc_html__( 'Three', 'wdb-addons' ),
					'4' => esc_html__( 'Four', 'wdb-addons' ),
				],
			]
		);
		...
		$this->add_responsive_control(
			'columns',
			[
				'label'          => esc_html__( 'Columns', 'wdb-addons' ),
				'type'           => Controls_Manager::SELECT,
		...
		$this->add_control(
			'posts_per_page',
			[
				'label'   => esc_html__( 'Posts Per Page', 'wdb-addons' ),
		...
		$this->add_control(
			'masonry',
			[
				'label'       => esc_html__( 'Masonry', 'wdb-addons' ),
				'type'        => Controls_Manager::SWITCHER,
				'label_off'   => esc_html__( 'Off', 'wdb-addons' ),
				'label_on'    => esc_html__( 'On', 'wdb-addons' ),
				'condition'   => [
					'columns!'      => '1',
					'element_list!' => '4',
				],
				'render_type' => 'template',
				'selectors'   => [
					'{{WRAPPER}} .wdb-posts' => 'grid-auto-flow: dense;',
				],
			]
		);
		...
		$this->add_control(
			'item_ratio',
			[
				'label'      => esc_html__( 'Item Height', 'wdb-addons' ),
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb-posts .thumb img' => 'height: {{SIZE}}{{UNIT}};',
				],
		...
		$this->add_control(
			'masonry_large',
			[
				'label'       => esc_html__( 'Masonry Large Items', 'wdb-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( '2, 6, 11', 'wdb-addons' ),
				'description' => esc_html__( 'Give the item sequence number with Coma separated.', 'wdb-addons' ),
				'ai'          => [
					'active' => false,
				],
				'condition'   => [
		...
		$this->add_control(
			'show_title',
			[
				'label'     => esc_html__( 'Show Title', 'wdb-addons' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'wdb-addons' ),
				'label_on'  => esc_html__( 'On', 'wdb-addons' ),
		...
		$this->add_control(
			'title_length',
			[
				'label'     => esc_html__( 'Title Length', 'wdb-addons' ),
				'type'      => Controls_Manager::NUMBER,
				'min'       => 5,
				'max'       => 100,
				'condition' => [
		...
		$this->add_control(
			'title_tag',
			[
				'label'     => esc_html__( 'Title HTML Tag', 'wdb-addons' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'h1'   => 'H1',
					'h2'   => 'H2',
		...
		$this->add_control(
			'show_meta',
			[
				'label'     => esc_html__( 'Meta', 'wdb-addons' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__( 'Show', 'wdb-addons' ),
				'label_off' => esc_html__( 'Hide', 'wdb-addons' ),
				'default'   => 'yes',
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'post_taxonomy',
			[
				'label'       => esc_html__( 'Taxonomy', 'wdb-addons' ),
		...
		$this->add_control(
			'show_date',
			[
				'label'     => esc_html__( 'Date', 'wdb-addons' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__( 'Show', 'wdb-addons' ),
				'label_off' => esc_html__( 'Hide', 'wdb-addons' ),
				'default'   => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label'      => esc_html__( 'Content', 'wdb-addons' ),
	...
	protected function register_design_layout_controls() {
		...
		$this->add_responsive_control(
			'column_gap',
			[
				'label'      => esc_html__( 'Columns Gap', 'wdb-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'default'    => [
					'size' => 30,
		...
		$this->add_responsive_control(
			'row_gap',
			[
				'label'      => esc_html__( 'Rows Gap', 'wdb-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'default'    => [
					'size' => 35,
		...
		$this->add_control(
			'el_hover_effects',
			[
				'label'        => esc_html__( 'Hover Effect', 'wdb-addons' ),
				'description'  => esc_html__( 'This effect will work only image tag.', 'wdb-addons' ),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'effect-zoom-in',
				'options'      => [
					''            => esc_html__( 'None', 'wdb-addons' ),
					'effect-zoom-in' => esc_html__( 'Zoom In', 'wdb-addons' ),
					'effect-zoom-out'  => esc_html__( 'Zoom Out', 'wdb-addons' ),
					'left-move'   => esc_html__( 'Left Move', 'wdb-addons' ),
					'right-move'  => esc_html__( 'Right Move', 'wdb-addons' ),
				],
	...
	public function register_pagination_section_controls() {
		$this->start_controls_section(
			'section_pagination',
			[
				'label' => esc_html__( 'Pagination', 'wdb-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					''                      => esc_html__( 'None', 'wdb-addons' ),
					'numbers_and_prev_next' => esc_html__( 'Numbers', 'wdb-addons' ) . ' + ' . esc_html__( 'Previous/Next', 'wdb-addons' ),
					'load_more'             => esc_html__( 'Load More', 'wdb-addons' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Page Limit', 'wdb-addons' ),
				'default'   => '5',
				'condition' => [
					'pagination_type!' => [
						'load_more',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Shorten', 'wdb-addons' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => '',
				'condition' => [
					'pagination_type' => [
		...
		$this->add_control(
			...
			[
				'label'            => esc_html__( 'Previous Arrow Icon', 'wdb-addons' ),
		...
		$this->add_control(
			...
			[
				'label'            => esc_html__( 'Next Arrow Icon', 'wdb-addons' ),
				'type'             => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'skin'             => 'inline',
				'label_block'      => false,
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Spacing', 'wdb-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'default'    => [
					'size' => 70,
		...
		$this->start_controls_section(
			'section_load_more',
			[
				'label'     => esc_html__( 'Load More', 'wdb-addons' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Colors', 'wdb-addons' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Background Color', 'wdb-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'pagination_spacing',
			[
				'label'      => esc_html__( 'Space Between', 'wdb-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'separator'  => 'before',
				'default'    => [
	...
	public function register_filter_section_controls() {
		$this->start_controls_section(
			'filter_bar',
			[
				'label' => esc_html__( 'Filter Bar', 'wdb-addons' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'show_filter_bar',
			[
				'label'     => esc_html__( 'Show', 'wdb-addons' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Off', 'wdb-addons' ),
				'label_on'  => esc_html__( 'On', 'wdb-addons' ),
			]
		...
		$this->add_control(
			'color_filter_active',
			[
				'label'     => esc_html__( 'Active Color', 'wdb-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render_filter_menu() {
		...
		<div class="filter">
			<button data-filter="all" >
				...
				<?php echo esc_html__( 'All', 'wdb-addons' ); ?>
			</button>
			<?php
	...
	protected function render_loop_footer() {
		...
		if ( 'numbers_and_prev_next' === $settings['pagination_type'] ) {
			$paginate_args = [
				...
				'before_page_number' => '<span class="elementor-screen-only">' . esc_html__( 'Page', 'wdb-addons' ) . '</span>',
			];
			?>
            <nav class="pf-pagination" aria-label="<?php esc_attr_e( 'Pagination', 'wdb-addons' ); ?>">
