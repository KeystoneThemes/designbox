...
class Mailchimp extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Mailchimp', 'wdb-addons' );
	}
	...
	protected function register_mailchimp_controls() {
		...
		$this->add_control(
			'mailchimp_api',
			[
				'label'       => __( 'MailChimp API', 'wdb-addons' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => __( 'Enter your mailchimp api here', 'wdb-addons' ),
				'dynamic'     => [ 'active' => true ],
			]
		);
		...
		$this->add_control(
			'mailchimp_lists',
			[
				'label'       => __( 'Audience', 'wdb-addons' ),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT2,
				'multiple'    => false,
				'placeholder' => 'Choose your created audience ',
				'options'     => [],
				'description' => esc_html__( 'Create a audience/ list in mailchimp account ', 'wdb-addons' ) . '<a href="https://mailchimp.com/help/create-audience/" target="_blank"> ' . esc_html__( 'Create Audience', 'wdb-addons' ) . '</a>',
			]
		);
		...
		$this->add_control(
			'mailchimp_list_tags',
			[
				'label'       => __( 'Tags', 'wdb-addons' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => __( 'Tag-1, Tag-2', 'wdb-addons' ),
				'description' => __( 'Enter tag here to separate your subscribers. Use comma separator to use multiple tags. Example: Tag-1, Tag-2, Tag-3', 'wdb-addons' ),
				'condition'   => [
					'mailchimp_lists!' => '',
				],
				'dynamic'     => [ 'active' => true ],
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Enable Double Opt In?', 'wdb-addons' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Yes', 'wdb-addons' ),
				'label_off'    => __( 'No', 'wdb-addons' ),
				'return_value' => 'yes',
				'default'      => 'no',
			]
		);
	...
	protected function register_form_content_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form', 'wdb-addons' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'toggle'    => true,
				'selectors' => [
					'{{WRAPPER}} .wdb-mailchimp-form' => 'justify-content: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'item_gap',
			[
				'label'      => esc_html__( 'Item Gap', 'wdb-addons' ),
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb-mailchimp-form' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'enable_name',
			[
				'label'        => esc_html__( 'Enable Name?', 'wdb-addons' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'wdb-addons' ),
				'label_off'    => esc_html__( 'No', 'wdb-addons' ),
				'return_value' => 'yes',
			]
		);
		...
		$this->add_control(
			'_fname_heading',
			[
				'label'     => esc_html__( 'First Name:', 'wdb-addons' ),
		...
		$this->add_control(
			'fname_label',
			[
				'label'       => esc_html__( 'Label', 'wdb-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'First Name', 'wdb-addons' ),
				'placeholder' => esc_html__( 'First Name', 'wdb-addons' ),
				'condition'   => [
					'enable_name' => 'yes',
				],
				'dynamic'     => [ 'active' => true ],
		...
		$this->add_control(
			'fname_placeholder',
			[
				'label'       => esc_html__( 'Placeholder', 'wdb-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'First Name', 'wdb-addons' ),
				'placeholder' => esc_html__( 'First Name', 'wdb-addons' ),
				'condition'   => [
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'before',
				'options'   => [
					'before' => esc_html__( 'Before', 'wdb-addons' ),
					'after'  => esc_html__( 'After', 'wdb-addons' ),
				],
				'condition' => [ 'enable_name' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'_lname_heading',
			[
				'label'     => esc_html__( 'Last Name:', 'wdb-addons' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'enable_name' => 'yes',
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Label', 'wdb-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Last Name', 'wdb-addons' ),
				'placeholder' => esc_html__( 'Last Name', 'wdb-addons' ),
				'condition'   => [
					'enable_name' => 'yes',
				],
				'dynamic'     => [ 'active' => true ],
		...
		$this->add_control(
			'enable_phone',
			[
				'label'        => esc_html__( 'Enable Phone?', 'wdb-addons' ),
				'type'         => Controls_Manager::SWITCHER,
				'separator'    => 'before',
				'label_on'     => esc_html__( 'Yes', 'wdb-addons' ),
				'label_off'    => esc_html__( 'No', 'wdb-addons' ),
		...
		$this->add_control(
			'_phone_heading',
			[
				'label'     => esc_html__( 'Phone:', 'wdb-addons' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'enable_phone' => 'yes',
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Label', 'wdb-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Phone', 'wdb-addons' ),
				'placeholder' => esc_html__( 'Phone', 'wdb-addons' ),
				'condition'   => [
					'enable_phone' => 'yes',
				],
				'dynamic'     => [ 'active' => true ],
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'before',
				'options'   => [
					'before' => __( 'Before', 'wdb-addons' ),
					'after'  => __( 'After', 'wdb-addons' ),
				],
				'condition' => [ 'enable_phone' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'_email_heading',
			[
				'label'     => esc_html__( 'Email:', 'wdb-addons' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Label', 'wdb-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Email', 'wdb-addons' ),
				'placeholder' => esc_html__( 'Email', 'wdb-addons' ),
				'dynamic'     => [ 'active' => true ],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Email', 'wdb-addons' ),
				'placeholder' => esc_html__( 'Email input placeholder', 'wdb-addons' ),
				'dynamic'     => [ 'active' => true ],
			]
		);
		...
		$this->add_control(
			'_button_heading',
			[
				'label'     => esc_html__( 'Button:', 'wdb-addons' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'button_text',
			[
				'label'   => esc_html__( 'Text', 'wdb-addons' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Subscribe', 'wdb-addons' ),
				'dynamic' => [ 'active' => true ],
			]
		);
		...
		$this->add_responsive_control(
			'button_icon_spacing',
			[
				'label'      => esc_html__( 'Icon Spacing', 'wdb-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb-mc-button' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function register_label_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'wdb-addons' ),
		...
		$this->add_responsive_control(
			'input_label_margin',
			[
				'label'      => esc_html__( 'Margin', 'wdb-addons' ),
	...
	protected function register_input_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Input', 'wdb-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Background', 'wdb-addons' ),
		...
		$this->add_responsive_control(
			'input_padding',
			[
				'label'      => esc_html__( 'Padding', 'wdb-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'separator'  => 'before',
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'input_width',
			[
				'label'      => esc_html__( 'Width', 'wdb-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'default'    => [
					'unit' => '%',
		...
		$this->add_group_control(
			...
			[
				'name'      => 'input_border',
				'label'     => esc_html__( 'Border', 'wdb-addons' ),
				'separator' => 'before',
				'selector'  => '{{WRAPPER}} .input input',
			]
		);
		...
		$this->add_responsive_control(
			'input_radius',
			[
				'label'      => esc_html__( 'Border Radius', 'wdb-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Box Shadow', 'wdb-addons' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Placeholder Color', 'wdb-addons' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#000000',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Font Size', 'wdb-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
	...
	protected function register_input_icon_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Input Icon', 'wdb-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function register_button_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'wdb-addons' ),
				'selector' => '{{WRAPPER}} .wdb-mc-button',
			]
		);
		...
		$this->add_responsive_control(
			'button_icon_size',
			[
				'label'      => esc_html__( 'Icon Size', 'wdb-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb-mc-button i'   => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .wdb-mc-button svg' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_tab(
			'button_normal_tab',
			[
				'label' => esc_html__( 'Normal', 'wdb-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-mc-button' => 'color: {{VALUE}}; fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-mc-button:hover, {{WRAPPER}} .wdb-mc-button:focus' => 'color: {{VALUE}}; fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Background', 'wdb-addons' ),
				'types'    => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .wdb-mc-button:hover, {{WRAPPER}} .wdb-mc-button:focus',
				'exclude'  => [
					'image',
				],
			]
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Border Color', 'wdb-addons' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wdb-mc-button:hover, {{WRAPPER}} .wdb-mc-button:focus' => 'border-color: {{VALUE}};',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .wdb-mc-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .wdb-mc-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .wdb-mc-button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .wdb-mc-button' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'wdb--mailchimp' );

		$this->add_render_attribute( 'wdb-mailchimp-form', [
			'class'           => 'wdb-mailchimp-form wdb--form-wrapper',
		...
		<div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
			...
			<form <?php $this->print_render_attribute_string( 'wdb-mailchimp-form' ); ?>>
				<?php
