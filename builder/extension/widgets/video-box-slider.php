...
class Video_Box_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( ' Video Box Slider', 'extension' );
	}
	...
	public function get_script_depends() {
		return [ 'swiper', 'magnific-popup', 'wdb--slider'];
	}
	...
	public function get_style_depends() {
		return [  'magnific-popup', 'wdb--video-box-slider' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Video Box Slider', 'extension' ),
			]
		);
		...
		$repeater->add_control(
			'video_thumb',
			[
				'label'   => esc_html__( 'Choose Image', 'extension' ),
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Type your sub title', 'extension' ),
			]
		);
		...
		$this->add_control(
			'video_slides',
			[
				'label'   => esc_html__( 'Video Slides', 'extension' ),
		...
		$this->add_control(
			'show_thumb_after',
			[
				'label'        => esc_html__( 'Thumbnail After', 'extension' ),
				'description'  => esc_html__( 'This settings for creating shape behind the thumbnail, Please enable the settings and use the style part for crating shape.', 'extension' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'extension' ),
				'label_off'    => esc_html__( 'Hide', 'extension' ),
				'return_value' => 'yes',
				'prefix_class' => 'wdb-thumb-',
			]
		);
		...
		$this->add_control(
			'thumb_after_display',
			[
				'label'        => esc_html__( 'Display', 'extension' ),
				'type'         => Controls_Manager::SELECT,
				'default'      => '',
				'options'      => [
					''                => esc_html__( 'Default', 'extension' ),
					'hover-slide'  => esc_html__( 'On Hover Slide', 'extension' ),
					'active-slide' => esc_html__( 'On Active Slide', 'extension' ),
				],
		...
		$this->add_responsive_control(
			'slider_width',
			[
				'label'      => esc_html__( 'Slider Max Width', 'extension' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Options', 'extension' ),
			]
		);
		...
		$this->add_control(
			'center_slide',
			[
				'label'        => esc_html__( 'Center Slide', 'extension' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'slide Scale', 'extension' ),
		...
		$this->add_control(
			'slide_scale_x',
			[
				'label'     => esc_html__( 'Slide Scale X', 'extension' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max'  => 1,
		...
		$this->add_control(
			'slide_scale_y',
			[
				'label'     => esc_html__( 'Slide Scale Y', 'extension' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max'  => 1,
		...
		$this->start_controls_section(
			...
			[
				'label'     => __( 'Thumbnail After', 'extension' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [ 'show_thumb_after' => 'yes' ]
			]
		);
		...
		$this->add_control(
			'title_margin',
			[
				'label'      => esc_html__( 'Margin', 'extension' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', ],
				'selectors'  => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Slider Navigation', 'extension' ),
				'tab'       => Controls_Manager::TAB_STYLE,
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Slider Pagination', 'extension' ),
				'tab'       => Controls_Manager::TAB_STYLE,
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper',
			[
				'class'         => [ 'wdb__slider-wrapper wdb__video_slider' ],
